...
<Sidebar {activeUrl}>
  <SidebarWrapper divClass="overflow-y-auto px-3 pt-20 lg:pt-5 h-full bg-white scrolling-touch max-w-2xs lg:h-[calc(100vh)] lg:block dark:bg-gray-800 lg:me-0 lg:sticky top-2">
    <SidebarGroup>
