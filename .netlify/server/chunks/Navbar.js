import { c as create_ssr_component, a as compute_rest_props, i as getContext, b as spread, d as escape_attribute_value, e as escape_object, s as setContext, h as subscribe, v as validate_component, f as add_attribute } from "./ssr.js";
import { i as is_void } from "./client.js";
import { F as Frame } from "./userStore.js";
import { B as Button } from "./Button.js";
import { N as Navbar, a as NavBrand, b as NavHamburger } from "./NavHamburger.js";
...
const Navbar_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: () => {
      ...
      })} ${validate_component(NavHamburger, "NavHamburger").$$render($$result, {}, {}, {})}</div> ${validate_component(NavUl, "NavUl").$$render($$result, { class: "order-1" }, {}, {
        default: () => {
