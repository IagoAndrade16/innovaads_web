...
const TrialPeriodWarning = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$userStore?.isOnTrial ? `<div class="col-span-full">${validate_component(Alert, "Alert").$$render(
    ...
    {},
    {
      ...
      default: () => {
        return `Atenção! Restam ${escape($userStore?.daysRemainingForTrial)} dias antes do seu período de teste acabar. Depois disso não será possível acessar as funcionalidades da plataforma.`;
      }
    }
    ...
    {},
    {
      default: () => {
        return `<div class="flex mt-3">${validate_component(InfoCircleSolid, "InfoCircleSolid").$$render($$result, { slot: "icon", class: "w-5 h-5" }, {}, {})}  
          Atenção! Seu período de testes acabou. Para continuar utilizando a plataforma, você precisa assinar um dos nossos planos.</div> <center>${validate_component(Button, "Button").$$render(
          $$result,
          {
            size: "md",
